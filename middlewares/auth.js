...
let isAuthenticated =(req,res,next)=>{
    if(req.params.authToken||req.query.authToken||req.header('authToken'))
    {
        if(req.params.authToken||req.query.authToken||req.header('authToken'))
        {
            if(req.params.authToken=="Admin"||req.query.authToken=="Admin"||req.header('authToken')=="Admin"||req.header('authToken')=="Admin")
            {
        ...
        logger.error('Authentication Token Missing','Authetication Middleware',5)
